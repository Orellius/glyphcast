...
regenerate, never hand-edit. Guidelines + downloads: [glyphcast.tv/brand](https://glyphcast.tv/brand).
...
If you run a modified glyphcast as a network service, the AGPL requires you to offer that
modified source to its users.

The bundled sample video is Big Buck Bunny, (c) Blender Foundation 2008, under CC-BY 3.0.
It ships only so the measurements in the proof lab above can be reproduced, and it carries
